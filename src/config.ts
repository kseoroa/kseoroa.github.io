export const siteConfig = {
  ...
  현재 (주)HDS에서 Python, Java 기반의 실시간 관제 시스템 및 위치정보 관리 시스템을 개발하고 있습니다. "코드는 읽기 쉬워야 한다"는 원칙 아래, 주석 없이도 의도가 드러나는 명확한 변수명과 간결한 함수 작성을 지향합니다. 선배 개발자들의 피드백을 빠르게 흡수하며 객체지향적인 설계와 클린 코드의 실무적 적용을 익히고 있습니다.

  테스트 코드를 개발의 당연한 한 과정으로 여깁니다. 120개 이상의 단위 테스트를 작성하며 코드의 안정성을 직접 체감했고, 이는 과감한 리팩토링과 시스템 고도화를 가능하게 하는 자신감의 원천이 되었습니다.
  
  기술적 기여뿐 아니라 팀의 효율을 높이는 소통에도 적극적입니다. 파편화된 API 문서를 Notion으로 체계화하여 팀 내 커뮤니케이션 비용을 절감했던 경험처럼, 작은 개선이 팀 전체에 가져오는 긍정적인 임팩트를 신뢰합니다. 동료와 함께 회고하고 코드 리뷰를 통해 함께 성장하는 환경을 즐깁니다.
  `,
